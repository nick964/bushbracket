      ...
      <header className="mb-6">
        <div className="flex items-start justify-between gap-3 border-b border-white/10 pb-3">
          ...
          <span className="flex shrink-0 items-start gap-2">
            <Link
              href="/scoreboard"
              className="label-caps mt-1 shrink-0 border border-orange-500/40 bg-orange-500/10 px-3 py-2 text-orange-400 transition-colors hover:bg-orange-500/20"
            >
              Scoreboard →
            </Link>
            <AuthControls />
        ...
        <div className="mt-5">
          ...
          <h1 className="mt-2 font-display text-3xl font-bold uppercase tracking-tighter text-zinc-100 sm:text-5xl">
            Bracket <span className="text-orange-500">Challenge</span>
          </h1>
          <p className="label-caps mt-2 text-zinc-500">
            Esports World Cup · Aug 5–9 · Call every game · Top score wins
          </p>
        </div>
