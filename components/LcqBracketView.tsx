...
const SECTIONS: Section<LcqGameId>[] = [
  {
    ...
    label: "Upper Bracket",
    caption:
      "All matches Bo5. Arrow Tech Edge has a bye straight into the quarterfinals. Lose anywhere up here and you drop to the lower bracket — one more loss and you're out.",
    rows: [
      {
        columns: [
          {
            title: "Round of 16",
            games: ["R2", "R3", "R4", "R5", "R6", "R7", "R8"],
          },
  ...
  },
  {
    ...
    label: "Lower Bracket",
    caption:
      "Ro16 losers pair off (the R2 loser walks straight into LB Round 2, thanks to the bye), then upper-bracket losers drop in each round. Survive it all to reach the LB Final against the UB Final loser.",
    rows: [
      {
        columns: [
          { title: "LB Round 1", games: ["LA2", "LA3", "LA4"] },
